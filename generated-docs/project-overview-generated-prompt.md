...
## プロジェクト情報
名前: recursive-folding
説明: # Recursive Folding
...
## ファイル詳細分析
**main.ts** (311行, 9623バイト)
  - 関数: onload, if, for, onunload, loadSettings, saveSettings
  - インポート: obsidian, obsidian

**styles.css** (9行, 164バイト)
  - 関数: なし
  - インポート: なし
...
---
Generated at: 2025-11-11 07:03:16 JST
